    ...
    public class DadosController : Controller
    {
        ...
        public IActionResult Alunos ()
        {
            ...
            for (int i=0; i < 100; i++)
            {
                ...
                aluno.cursoID = rand.Next(1, 8);
                aluno.periodo = (Periodo) (rand.Next(1, 3));
                aluno.aniversario = Convert.ToDateTime("01/01/1956").AddDays(rand.Next(1,18260));
                contexto.Alunos.Add(aluno);
            }

            contexto.SaveChanges(); 

            return View(contexto.Alunos.Include(a => a.curso).ToList());
        }
        ...
        public IActionResult Atendimentos()
        {
            ...
            for (int i = 0; i < 1000; i++)
            {
                ...
                atendimento.data = Convert.ToDateTime("01/01/2010").AddDays(rand.Next(0, 5407)).AddSeconds(rand.Next(1, 86400));
